...
var _jrootham$cabal_voting$Parse$dateDecoder = A2(
	...
	_elm_lang$core$Json_Decode$string);
var _jrootham$cabal_voting$Parse$ErrorAndPaperList = F2(
	function (a, b) {
		return {error: a, paperList: b};
	});
...
var _jrootham$cabal_voting$Parse$Reference = F2(
	function (a, b) {
...
var _jrootham$cabal_voting$Parse$referenceDecoder = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jrootham$cabal_voting$Parse$Reference)));
...
var _jrootham$cabal_voting$Parse$decodeErrorAndPaperList = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'paper_list',
	...
	A3(
		...
		'error',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_jrootham$cabal_voting$Parse$ErrorAndPaperList)));
var _jrootham$cabal_voting$Parse$parse = function (responseString) {
	return A2(_elm_lang$core$Json_Decode$decodeString, _jrootham$cabal_voting$Parse$decodeErrorAndPaperList, responseString);
};

var _jrootham$cabal_voting$Demo$getPaper = F2(
...
var _jrootham$cabal_voting$Demo$delete = F2(
	function (paperList, id) {
		return A2(
			_elm_lang$core$List$filter,
			function (paper) {
...
var _jrootham$cabal_voting$Demo$newPaper = function (submitter) {
	return A8(
...
var _jrootham$cabal_voting$Demo$getPaperList = function () {
	...
	var ref2 = A2(
		_jrootham$cabal_voting$Parse$Reference,
		2,
		A2(_jrootham$cabal_voting$Parse$Link, 'Reference 2', 'https://xkcd.com/1858/'));
	...
	var ref1 = A2(
		_jrootham$cabal_voting$Parse$Reference,
		1,
		A2(_jrootham$cabal_voting$Parse$Link, 'Reference 1', 'https://xkcd.com/1863/'));
...
var _jrootham$cabal_voting$Demo$isUser = function (name) {
	return A2(
...
var _jrootham$cabal_voting$Payload$paperElement = function (paper) {
	return {
		ctor: '_Tuple2',
		_0: 'paper',
...
var _jrootham$cabal_voting$Payload$userElement = function (user) {
	return {
		ctor: '_Tuple2',
		_0: 'user',
...
var _jrootham$cabal_voting$Payload$makePayload = function (payloadList) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		0,
		_elm_lang$core$Json_Encode$object(payloadList));
};
var _jrootham$cabal_voting$Payload$loginPayload = function (user) {
	return _jrootham$cabal_voting$Payload$makePayload(
		{
			ctor: '::',
			_0: _jrootham$cabal_voting$Payload$userElement(user),
			_1: {ctor: '[]'}
		});
};
var _jrootham$cabal_voting$Payload$paperPayload = F2(
	function (user, paper) {
		return _jrootham$cabal_voting$Payload$makePayload(
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _jrootham$cabal_voting$Payload$paperElement(paper),
					_1: {ctor: '[]'}
				}
			});
	});
var _jrootham$cabal_voting$Payload$votePayload = F3(
	function (name, paperId, increment) {
		return _jrootham$cabal_voting$Payload$makePayload(
			{
				ctor: '::',
				_0: _jrootham$cabal_voting$Payload$userElement(name),
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'increment',
							_1: _elm_lang$core$Json_Encode$int(increment)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _jrootham$cabal_voting$Payload$closePayload = F2(
	function (name, paperId) {
		return _jrootham$cabal_voting$Payload$makePayload(
			{
				ctor: '::',
				_0: _jrootham$cabal_voting$Payload$userElement(name),
...
var _jrootham$cabal_voting$Main$getVotes = F2(
		...
		if (_p0.ctor === 'Just') {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					...
					end: {line: 596, column: 44}
				},
				_p0)('Should have votes');
		}
	});
var _jrootham$cabal_voting$Main$compareVotes = F3(
	function (name, left, right) {
		return _elm_lang$core$Native_Utils.eq(
			A2(_jrootham$cabal_voting$Main$getVotes, name, left),
			A2(_jrootham$cabal_voting$Main$getVotes, name, right)) ? _elm_lang$core$Basics$EQ : ((_elm_lang$core$Native_Utils.cmp(
			A2(_jrootham$cabal_voting$Main$getVotes, name, left),
			A2(_jrootham$cabal_voting$Main$getVotes, name, right)) < 0) ? _elm_lang$core$Basics$GT : _elm_lang$core$Basics$LT);
	});
...
var _jrootham$cabal_voting$Main$votes = function (name) {
	...
	return F2(
		function (left, right) {
			return (voterIn(left) && voterIn(right)) ? A3(_jrootham$cabal_voting$Main$compareVotes, name, left.votes, right.votes) : (((!voterIn(left)) && voterIn(right)) ? _elm_lang$core$Basics$GT : ((voterIn(left) && (!voterIn(right))) ? _elm_lang$core$Basics$LT : (((!voterIn(left)) && (!voterIn(right))) ? _elm_lang$core$Basics$EQ : _elm_lang$core$Native_Utils.crash(
				'Main',
				{
					start: {line: 626, column: 17},
					end: {line: 626, column: 28}
				})('votes: This should be impossible'))));
		});
};
var _jrootham$cabal_voting$Main$validateAdd = function (model) {
	return _elm_lang$core$Native_Utils.cmp(
		_jrootham$cabal_voting$Config$maxPapers,
...
var _jrootham$cabal_voting$Main$voteTable = function (votes) {
...
var _jrootham$cabal_voting$Main$widerFlatButton = _jrootham$cabal_voting$Main$flatButton('wider');
...
var _jrootham$cabal_voting$Main$makeNewReference = F4(
	function (setFunction, maybePaper, referenceIndex, newText) {
		...
		if (_p2.ctor === 'Just') {
			...
			var newReferences = A2(_elm_lang$core$List$map, setLink, _p3.references);
			return _elm_lang$core$Maybe$Just(
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 408, column: 5},
					end: {line: 423, column: 52}
				},
				_p2)('Paper needs to be present');
		}
	});
...
var _jrootham$cabal_voting$Main$deleteReference = F2(
	function (maybePaper, referenceIndex) {
		...
		if (_p5.ctor === 'Just') {
			...
			var trimmedReferences = A2(_elm_lang$core$List$filter, trim, _p6.references);
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 393, column: 5},
					end: {line: 404, column: 52}
				},
				_p5)('Paper needs to be present');
		}
	});
var _jrootham$cabal_voting$Main$addReference = function (maybePaper) {
	...
	if (_p8.ctor === 'Just') {
		...
		var newReference = A2(
			_jrootham$cabal_voting$Parse$Reference,
			newIndex,
			A2(_jrootham$cabal_voting$Parse$Link, '', ''));
		return _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.update(
				_p10,
				{
					references: {ctor: '::', _0: newReference, _1: _p10.references}
				}));
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				...
				end: {line: 381, column: 52}
			},
			_p8)('Paper needs to be present');
	}
};
...
var _jrootham$cabal_voting$Main$editLink = F3(
...
var _jrootham$cabal_voting$Main$formatError = function (error) {
	...
	switch (_p18.ctor) {
		case 'BadUrl':
			return A2(_elm_lang$core$Basics_ops['++'], 'Bad URL ', _p18._0);
		case 'Timeout':
			return 'Timeout';
		case 'NetworkError':
		...
		case 'BadStatus':
			...
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'Bad status:',
				A2(_elm_lang$core$Basics_ops['++'], _p19.status.message, _p19.body));
		default:
			return A2(_elm_lang$core$Basics_ops['++'], 'Bad payload', _p18._0);
	}
};
...
var _jrootham$cabal_voting$Main$updateModel = F2(
	function (model, response) {
		var _p20 = _jrootham$cabal_voting$Parse$parse(response);
		if (_p20.ctor === 'Ok') {
			var _p21 = _p20._0;
			var papers = _p21.paperList;
			var error = _p21.error;
			if (_elm_lang$core$Native_Utils.eq(error, '')) {
				var sortVoter = _elm_lang$core$Native_Utils.eq(model.voter, '') ? model.name : model.voter;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						errorMessage: '',
						...
						papers: papers,
						voters: _jrootham$cabal_voting$Main$getVoters(papers),
						voter: sortVoter
					});
			} else {
				return _elm_lang$core$Native_Utils.update(
...
var _jrootham$cabal_voting$Main$editReference = function (reference) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A3(
				_jrootham$cabal_voting$Main$widerFlatButton,
				true,
				_jrootham$cabal_voting$Main$DeleteReference(reference.index),
				'Delete reference'),
			_1: {
				ctor: '::',
				_0: A3(
					_jrootham$cabal_voting$Main$editLink,
					_jrootham$cabal_voting$Main$InputReferenceText(reference.index),
					_jrootham$cabal_voting$Main$InputReferenceLink(reference.index),
					reference.link),
				_1: {ctor: '[]'}
			}
		});
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$List$map,
									_jrootham$cabal_voting$Main$editReference,
									A2(
...
var _jrootham$cabal_voting$Main$editPaperLink = function (paper) {
	return A3(_jrootham$cabal_voting$Main$editLink, _jrootham$cabal_voting$Main$InputPaperText, _jrootham$cabal_voting$Main$InputPaperLink, paper.paper);
};
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_jrootham$cabal_voting$Main$inputDiv, 'Title: ', _p23.title, _jrootham$cabal_voting$Main$InputTitle),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _jrootham$cabal_voting$Main$editPaperLink(_p23),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p23.comment),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_jrootham$cabal_voting$Main$editReferences, _p23.id, _p23.references),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A3(_jrootham$cabal_voting$Main$normalFlatButton, model.debounce, _jrootham$cabal_voting$Main$Save, 'Save'),
										_1: {
											ctor: '::',
...
var _jrootham$cabal_voting$Main$Close = function (a) {
...
var _jrootham$cabal_voting$Main$fetch = function (payload) {
	var url = _jrootham$cabal_voting$Config$backend;
				...
				if (_p24._0.ctor === 'Ok') {
					return {
						...
						_0: _jrootham$cabal_voting$Main$debounce(
							A2(_jrootham$cabal_voting$Main$updateModel, model, _p24._0._0)),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errorMessage: _jrootham$cabal_voting$Main$formatError(_p24._0._0),
								debounce: true
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'DoEdit':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							page: _jrootham$cabal_voting$Main$Edit,
							edit: A2(_jrootham$cabal_voting$Demo$getPaper, model.papers, _p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Close':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{debounce: false}),
					_1: _jrootham$cabal_voting$Main$fetch(
						A2(_jrootham$cabal_voting$Payload$closePayload, model.name, _p24._0))
				};
			case 'IncrementVote':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{debounce: false}),
					_1: _jrootham$cabal_voting$Main$fetch(
						A3(_jrootham$cabal_voting$Payload$votePayload, model.name, _p24._0, 1))
				};
			case 'DecrementVote':
				return {
					ctor: '_Tuple2',
			...
			case 'InputTitle':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A2(_jrootham$cabal_voting$Main$makeNewTitle, model.edit, _p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InputPaperText':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A2(_jrootham$cabal_voting$Main$makeNewPaperText, model.edit, _p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InputPaperLink':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A2(_jrootham$cabal_voting$Main$makeNewPaperLink, model.edit, _p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InputComment':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A2(_jrootham$cabal_voting$Main$makeNewComment, model.edit, _p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddReference':
			...
			case 'DeleteReference':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A2(_jrootham$cabal_voting$Main$deleteReference, model.edit, _p24._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InputReferenceText':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A3(_jrootham$cabal_voting$Main$makeNewReferenceText, model.edit, _p24._0, _p24._1)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InputReferenceLink':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							edit: A3(_jrootham$cabal_voting$Main$makeNewReferenceLink, model.edit, _p24._0, _p24._1)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Save':
				...
				if (_p25.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{debounce: false}),
						_1: _jrootham$cabal_voting$Main$fetch(
							A2(_jrootham$cabal_voting$Payload$paperPayload, model.name, _p25._0))
					};
				} else {
					return {
						ctor: '_Tuple2',
							...
							_elm_lang$core$Basics_ops['++'],
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _jrootham$cabal_voting$Main$makeLink(paper.paper),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
							...
							A2(
								...
								function (ref) {
									return A2(
										...
										{
											ctor: '::',
											_0: _jrootham$cabal_voting$Main$makeLink(ref.link),
											_1: {ctor: '[]'}
										});
								},
								A2(
					...
					_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_0: A3(
															_jrootham$cabal_voting$Main$thinFlatButton,
															model.debounce && A2(_jrootham$cabal_voting$Main$voteLimit, model, thisVoterCount),
						...
						_1: {
							...
							_0: A2(
								...
								_jrootham$cabal_voting$Main$voteTable(paper.votes)),
							_1: {ctor: '[]'}
						}
					}
				}
						...
						_1: {
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_jrootham$cabal_voting$Main$ChangeOrder(order)),
								_1: {
									ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_jrootham$cabal_voting$Main$userLine(model)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(radio, ' Earliest ', _jrootham$cabal_voting$Main$Earliest),
								_1: {
									ctor: '::',
									_0: A2(radio, ' Latest ', _jrootham$cabal_voting$Main$Latest),
									_1: {
										ctor: '::',
										_0: A2(radio, ' Most votes ', _jrootham$cabal_voting$Main$MostVotes),
										_1: {
											ctor: '::',
											_0: A2(radio, ' Least votes ', _jrootham$cabal_voting$Main$LeastVotes),
											_1: {
												ctor: '::',
												_0: A2(radio, ' Submitter ', _jrootham$cabal_voting$Main$Submitter),
												_1: {
													ctor: '::',
													_0: A2(radio, ' My Papers ', _jrootham$cabal_voting$Main$Mine),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$div,
															...
															{
																ctor: '::',
																_0: A3(radioSelected, true, ' Voter ', _jrootham$cabal_voting$Main$Voter),
																_1: {
																	ctor: '::',
																	_0: A2(
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A3(
								_jrootham$cabal_voting$Main$normalFlatButton,
								model.debounce && _jrootham$cabal_voting$Main$validateAdd(model),
								_jrootham$cabal_voting$Main$Add,
								'Add'),
							_1: {
								ctor: '::',
...
var _jrootham$cabal_voting$Main$loginPage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_jrootham$cabal_voting$Main$normalFlatButton, model.debounce, _jrootham$cabal_voting$Main$StartLogin, 'Login'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Test Cabal Voting System'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: function () {
					...
					switch (_p28.ctor) {
						...
						default:
							return _jrootham$cabal_voting$Main$editPage(model);
					}
				}(),
				_1: {ctor: '[]'}
			}
