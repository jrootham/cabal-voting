...
var _jrootham$cabal_voting$Payload$makePayload = F2(
	function (owner, name) {
		var vars = _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'owner',
					_1: _elm_lang$core$Json_Encode$string(owner)
				},
				_1: {
					ctor: '::',
					_0: {
		...
		var ship = A2(
			_elm_lang$core$String$join,
			' ',
			_elm_lang$core$String$lines(fromGraphQLi));
		return A2(
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'variables', _1: vars},
						_1: {ctor: '[]'}
					}
				}));
	});

var _jrootham$cabal_voting$ReadOnly$totalOrder = F3(
...
var _jrootham$cabal_voting$ReadOnly$nameIn = F2(
	function (name, paper) {
		return A2(_elm_lang$core$List$member, name, paper.votes);
	});
var _jrootham$cabal_voting$ReadOnly$votes = function (name) {
	var voterIn = _jrootham$cabal_voting$ReadOnly$nameIn(name);
	return F2(
		function (left, right) {
...
var _jrootham$cabal_voting$ReadOnly$voteLimit = function (model) {
	return _elm_lang$core$Native_Utils.cmp(
		_jrootham$cabal_voting$Config$maxVotes,
		_jrootham$cabal_voting$ReadOnly$countVotes(model)) > -1;
};
var _jrootham$cabal_voting$ReadOnly$userLine = function (model) {
	var totalString = A2(
	...
	var voteString = _elm_lang$core$Basics$toString(
		_jrootham$cabal_voting$ReadOnly$countVotes(model));
	var votingString = A2(
		_elm_lang$core$Basics_ops['++'],
		' voted for  ',
		A2(
...
var _jrootham$cabal_voting$ReadOnly$updateModel = F2(
...
var _jrootham$cabal_voting$ReadOnly$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'FetchResult':
				if (_p4._0.ctor === 'Ok') {
					return A2(_jrootham$cabal_voting$ReadOnly$updateModel, model, _p4._0._0);
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								fetchError: _jrootham$cabal_voting$ReadOnly$formatError(_p4._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _jrootham$cabal_voting$ReadOnly$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _jrootham$cabal_voting$ReadOnly$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {key: a, name: b, fetchError: c, papers: d, order: e, voter: f, voters: g};
	});
var _jrootham$cabal_voting$ReadOnly$Voter = {ctor: 'Voter'};
var _jrootham$cabal_voting$ReadOnly$MyVotes = {ctor: 'MyVotes'};
var _jrootham$cabal_voting$ReadOnly$Submitter = {ctor: 'Submitter'};
var _jrootham$cabal_voting$ReadOnly$MostVotes = {ctor: 'MostVotes'};
var _jrootham$cabal_voting$ReadOnly$LeastVotes = {ctor: 'LeastVotes'};
var _jrootham$cabal_voting$ReadOnly$Latest = {ctor: 'Latest'};
var _jrootham$cabal_voting$ReadOnly$Earliest = {ctor: 'Earliest'};
var _jrootham$cabal_voting$ReadOnly$Title = {ctor: 'Title'};
var _jrootham$cabal_voting$ReadOnly$Clear = {ctor: 'Clear'};
var _jrootham$cabal_voting$ReadOnly$FetchResult = function (a) {
	return {ctor: 'FetchResult', _0: a};
};
var _jrootham$cabal_voting$ReadOnly$githubFetch = function (key) {
	...
	return A2(_elm_lang$http$Http$send, _jrootham$cabal_voting$ReadOnly$FetchResult, req);
};
var _jrootham$cabal_voting$ReadOnly$init = function (key) {
	return {
		ctor: '_Tuple2',
		_0: A7(
			_jrootham$cabal_voting$ReadOnly$Model,
			key,
			'',
			'',
			{ctor: '[]'},
			_jrootham$cabal_voting$ReadOnly$Title,
			'',
			{ctor: '[]'}),
		_1: _jrootham$cabal_voting$ReadOnly$githubFetch(key)
	};
};
var _jrootham$cabal_voting$ReadOnly$ChangeVoter = function (a) {
	return {ctor: 'ChangeVoter', _0: a};
};
var _jrootham$cabal_voting$ReadOnly$ChangeOrder = function (a) {
	return {ctor: 'ChangeOrder', _0: a};
};
var _jrootham$cabal_voting$ReadOnly$radioBase = F4(
						...
						_1: {
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_jrootham$cabal_voting$ReadOnly$ChangeOrder(order)),
								_1: {
									ctor: '::',
...
var _jrootham$cabal_voting$ReadOnly$page = function (model) {
	var compare = function () {
		var _p5 = model.order;
		switch (_p5.ctor) {
			case 'Title':
				return _jrootham$cabal_voting$ReadOnly$totalOrder(
					F2(
						function (left, right) {
			...
			case 'MostVotes':
				return _jrootham$cabal_voting$ReadOnly$totalOrder(
					F2(
						function (left, right) {
							return _elm_lang$core$Native_Utils.cmp(
								_elm_lang$core$List$length(right.votes),
								_elm_lang$core$List$length(left.votes)) < 0;
						}));
			case 'LeastVotes':
				return _jrootham$cabal_voting$ReadOnly$totalOrder(
					F2(
						function (left, right) {
							return _elm_lang$core$Native_Utils.cmp(
								_elm_lang$core$List$length(left.votes),
								_elm_lang$core$List$length(right.votes)) < 0;
						}));
			case 'Submitter':
				return _jrootham$cabal_voting$ReadOnly$totalOrder(
					F2(
			...
			case 'MyVotes':
				return _jrootham$cabal_voting$ReadOnly$votes(model.name);
			default:
				return _jrootham$cabal_voting$ReadOnly$votes(model.voter);
		}
	}();
	var radioSelected = _jrootham$cabal_voting$ReadOnly$radioBase(model.order);
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_jrootham$cabal_voting$ReadOnly$userLine(model)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: A2(radio, ' Title ', _jrootham$cabal_voting$ReadOnly$Title),
							_1: {
								ctor: '::',
								_0: A2(radio, ' Earliest ', _jrootham$cabal_voting$ReadOnly$Earliest),
								_1: {
									ctor: '::',
									_0: A2(radio, ' Latest ', _jrootham$cabal_voting$ReadOnly$Latest),
									_1: {
										ctor: '::',
										_0: A2(radio, ' Most votes ', _jrootham$cabal_voting$ReadOnly$MostVotes),
										_1: {
											ctor: '::',
											_0: A2(radio, ' Least votes ', _jrootham$cabal_voting$ReadOnly$LeastVotes),
											_1: {
												ctor: '::',
												_0: A2(radio, ' Submitter ', _jrootham$cabal_voting$ReadOnly$Submitter),
												_1: {
													ctor: '::',
													_0: A2(radio, ' My votes ', _jrootham$cabal_voting$ReadOnly$MyVotes),
													_1: {
														ctor: '::',
														_0: A3(
															radioSelected,
															...
															' Voter ',
															_jrootham$cabal_voting$ReadOnly$Voter),
														_1: {
															ctor: '::',
															_0: A2(
																		...
																		return A2(
																			_elm_lang$html$Html$option,
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(
																						_jrootham$cabal_voting$ReadOnly$ChangeVoter(voter)),
																					_1: {ctor: '[]'}
																				}
																			},
																			{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: A2(
										_elm_lang$core$List$map,
										A2(
											_jrootham$cabal_voting$ReadOnly$displayPaper,
											model,
											_jrootham$cabal_voting$ReadOnly$voteLimit(model)),
...
var _jrootham$cabal_voting$ReadOnly$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_0: _elm_lang$core$Native_Utils.eq(model.fetchError, '') ? A2(
					...
					{
						ctor: '::',
						_0: _jrootham$cabal_voting$ReadOnly$page(model),
						_1: {ctor: '[]'}
					}) : A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
...
var _jrootham$cabal_voting$ReadOnly$main = _elm_lang$html$Html$programWithFlags(
	{init: _jrootham$cabal_voting$ReadOnly$init, view: _jrootham$cabal_voting$ReadOnly$view, update: _jrootham$cabal_voting$ReadOnly$update, subscriptions: _jrootham$cabal_voting$ReadOnly$subscriptions})(_elm_lang$core$Json_Decode$string);

var Elm = {};
Elm['ReadOnly'] = Elm['ReadOnly'] || {};
if (typeof _jrootham$cabal_voting$ReadOnly$main !== 'undefined') {
    _jrootham$cabal_voting$ReadOnly$main(Elm['ReadOnly'], 'ReadOnly', undefined);
}
